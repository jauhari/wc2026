...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata({
    title: "Piala Dunia 2026 — Arsip",
    description:
      "Arsip Piala Dunia FIFA 2026 — hasil pertandingan, klasemen grup, jadwal lengkap, bagan guguran, dan statistik pemain. Turnamen telah selesai.",
    path: "/wc2026",
  })
}

export default async function Wc2026OverviewPage() {
        ...
        <CardContent className="relative flex flex-col gap-6 p-6 md:flex-row md:items-center md:justify-between md:p-8">
          <div className="flex flex-col gap-3">
            <Badge className="w-fit bg-white/20 text-primary-foreground hover:bg-white/30">
              11 Juni – 19 Juli 2026 · Selesai
            </Badge>
            <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
              FIFA World Cup 2026
            </h1>
            <p className="max-w-lg text-primary-foreground/90">
              Arsip turnamen — hasil, klasemen, jadwal, bagan, dan statistik.
